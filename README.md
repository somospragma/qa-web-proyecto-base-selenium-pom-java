# Arquetipo Selenium POM


## Name
Proyecto base de Selenium con Page Object Model (POM)

## Description
This project aims to establish a standard base for test automation with Selenium and POM
